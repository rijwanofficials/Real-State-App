...
function Navbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-6 md:px-[80px] py-[18px] bg-white shadow-md">
            {/* Logo */}
            <Link to="/">
                <img
                    src={logo}
            ...
            {/* Desktop Nav */}
            <ul className="hidden md:flex gap-6 text-[16px] font-medium list-none">
